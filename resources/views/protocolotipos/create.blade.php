...
<div class="container">
  <form method="POST" action="{{ route('protocolotipos.store') }}">
    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-plus-square"></i> Incluir Tipo de Protocolo</button>
  </form>
  <div class="float-right">
    <a href="{{ route('protocolotipos.index') }}" class="btn btn-secondary btn-sm" role="button"><i class="fas fa-long-arrow-alt-left"></i> Voltar</i></a>
  </div>
</div>
@endsection
